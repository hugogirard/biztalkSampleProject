namespace EAISchemas {
    ...
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::EAISchemas.PropertySchema.GrandTotal), XPath = @"/*[local-name()='Request' and namespace-uri()='http://EAISchemas.Request']/*[local-name()='Header' and namespace-uri()='']/*[local-name()='GrandTotal' and namespace-uri()='']", XsdType = @"unsignedInt")]
